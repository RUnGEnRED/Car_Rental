...
/**
 * Reservation is an entity class that represents a reservation in the car rental system.
 */
@Entity
...
public class Reservation {
    ...
    /**
     * Gets the class type of the reservation.
     *
     * @return The class type of the reservation.
     */
    ...
    /**
     * Sets the class type of the reservation.
     *
