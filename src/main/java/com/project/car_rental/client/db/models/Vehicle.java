...
/**
 * This class represents a vehicle in the car rental system.
 */
@Entity
@Table(name = "vehicle")
public class Vehicle {
     ...
     *
     * @param classType The class type of the vehicle.
     */
     ...
     *
     * @param yearOfProduction The year of production of the vehicle.
     */
     ...
     *
     * @param fuelConsumption The fuel consumption of the vehicle.
     */
